        ...
        <Col md={6} className="mb-4">
          <Card className="h-100">
            <Card.Body>
              ...
              <Card.Text>Browse and explore available courses.</Card.Text>
              <Link to="/courses">
          ...
          <Col md={6} className="mb-4">
            <Card className="h-100">
              <Card.Body>
                ...
                <Card.Text>View and manage your profile and enrolled courses.</Card.Text>
                <Link to="/profile">
          ...
          <Col md={6} className="mb-4">
            <Card className="h-100">
              <Card.Body>
                ...
                <Card.Text>Manage student information and registrations.</Card.Text>
                <Link to="/students">
